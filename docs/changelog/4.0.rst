...
`2016-02 <security/powerdns-advisory-2016-02.md>`__,
`2016-03 <security/powerdns-advisory-2016-03.md>`__,
`2016-04 <security/powerdns-advisory-2016-04.md>`__ and
`2016-05 <security/powerdns-advisory-2016-05.md>`__ and includes a fix
...
-  `commit f61af48 <https://github.com/PowerDNS/pdns/commit/f61af48>`__:
   ...
   Advisory `2016-02 <security/powerdns-advisory-2016-02.md>`__)
...
-  `commit 3b1e4a2 <https://github.com/PowerDNS/pdns/commit/3b1e4a2>`__:
   ...
   `2016-05 <security/powerdns-advisory-2016-05.md>`__)
...
-  All backends derived from the Generic SQL backend use `prepared
   statements <authoritative/backend-generic-sql.md>`__.
...
-  A revived ODBC backend
   (`godbc <authoritative/backend-generic-odbc.md>`__).
-  A revived LDAP backend (`ldap <authoritative/backend-ldap.md>`__).
-  Support for
   `CDS/CDNSKEY <authoritative/howtos.md#cds-cdnskey-key-rollover>`__
   and `RFC 7344 <https://tools.ietf.org/html/rfc7344>`__ key-rollovers.
-  Support for the
   `ALIAS <authoritative/howtos.md#using-alias-records>`__ record.
...
-  Many new ``pdnsutil`` commands
   ...
   -  ``edit-zone`` command that spawns ``$EDITOR`` with the zone
      ...
      (`blogpost <http://blog.powerdns.com/2016/02/02/powerdns-authoritative-the-new-old-way-to-manage-domains/>`__

The following backend have been dropped in 4.0.0:

-  LMDB.
-  Geo (use the improved `GeoIP <authoritative/backend-geoip.md>`__
   instead).
...
-  `#3428 <https://github.com/PowerDNS/pdns/pull/3428>`__ API: Fix
   ...
   -  **Note**: this is a breaking change from alpha1, please review the
      `API documentation <httpapi/api_spec.md>`__
