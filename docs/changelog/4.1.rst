...
.. changelog::
  ...
  .. change::
    ...
    Make sure AXFR only deletes records from a SLAVE domain in a multi backend setups (Kees Monshouwer).
  ...
  .. change::
    ...
    This prevents hammering down or already busy servers.
  ...
  .. change::
    ...
    Disable ALIAS expension by default.
  ...
  .. change::
    ...
    Fix and erroneous '.' in ".ip6.arpa" (@shantikulkarni).
  ...
  .. change::
    ...
    Remove the experimental Lua Polocy Engine (Aki Tuomi).
